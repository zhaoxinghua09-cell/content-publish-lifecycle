---
name: content-publish-lifecycle
displayName: 内容发布全流程（设计→落地→检查→验证→发布→沉淀）
slug: content-publish-lifecycle
author: 诺声(Logos)@SynomosAI
copyright: SynomosAI
version: 1.0.0
license: MIT
description: 把技术方案 / 设计从「设计 → 落地 → 检查 → 验证 → 发布 → 沉淀」串成一条可复用发布流水线，用于回答「方案做完了怎么变成能发的东西」「发出去之前该查什么」这类问题
tags:
- 诺声
- AI技能
- SynomosAI
...
category: 文档处理
platforms: [ClawHub, SkillHub, SkillPie, GitHub, Gitee]
languages:
- zh-CN
- en
- ja
...
agent_created: true
updated: 2026-08-28
fingerprint: FP-MX-3AD01AE9E451
...
> 时间戳 2026-08-28 ｜ 指纹 FP-MX-3AD01AE9E451
